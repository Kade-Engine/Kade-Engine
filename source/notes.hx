	...
	public function new(strumTime:Float, noteData:Int, ?prevNote:Note, ?sustainNote:Bool = false, ?customImage:Null<BitmapData>, ?customXml:Null<String>, ?customEnds:Null<BitmapData>)
	{
		...
		switch (PlayState.SONG.uiType)
		{
			case 'isSong':
				if (DownScroll=='true')
				{
					loadGraphic('assets/shared/images/Note_ASSETS-down', true, 17, 17);
				}
				if (UpScroll=='true')
				{
					loadGraphic('assets/shared/images/Note_ASSETS-up', true, 17, 17);
				}
				isSong = true;
			...
			case 'normalNotes':
				...
				assetsNote = (UpScroll, DownScroll);
